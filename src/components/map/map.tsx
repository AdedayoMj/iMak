...
const Map: React.FunctionComponent<IMap> = ({
  mapType,
  mapTypeControl = false,
  setDistanceInKm,
}) => {
  const homeLocation = new google.maps.LatLng(59.393269, 24.651899);
  ...
  const defaultMapStart = (): void => {
    const defaultAddress = new google.maps.LatLng(59.393269, 24.651899);
